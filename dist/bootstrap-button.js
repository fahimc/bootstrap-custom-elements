...
(function (global, factory) {
  ...
  $(_containerElement).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE_CARROT, function (event) {
...
//# sourceMappingURL=button.js.map
                ...
                getTemplate(){
                    return `
                    <button type="button" class="btn btn-${this.props.type?this.props.type: 'primary'}">
    <slot></slot>
</button>
                    `;
                }
